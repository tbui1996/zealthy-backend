...
// SonarIdentityProvider is an autogenerated mock type for the SonarIdentityProvider type
type SonarIdentityProvider struct {
	mock.Mock
}

// AdminAddUserToGroup provides a mock function with given fields: username, groupName
func (_m *SonarIdentityProvider) AdminAddUserToGroup(username string, groupName string) (*cognitoidentityprovider.AdminAddUserToGroupOutput, error) {
...
func (_m *SonarIdentityProvider) AdminDisableUser(username string) (*cognitoidentityprovider.AdminDisableUserOutput, error) {
...
func (_m *SonarIdentityProvider) AdminEnableUser(username string) (*cognitoidentityprovider.AdminEnableUserOutput, error) {
	ret := _m.Called(username)
...
func (_m *SonarIdentityProvider) AdminGetUser(username string) (*cognitoidentityprovider.AdminGetUserOutput, error) {
	ret := _m.Called(username)
...
func (_m *SonarIdentityProvider) AdminListGroupsForUser(username string) (*cognitoidentityprovider.AdminListGroupsForUserOutput, *exception.SonarError) {
	ret := _m.Called(username)
...
func (_m *SonarIdentityProvider) AdminRemoveUserFromGroup(username string, groupName string) (*cognitoidentityprovider.AdminRemoveUserFromGroupOutput, error) {
	ret := _m.Called(username, groupName)
...
func (_m *SonarIdentityProvider) AdminUserGlobalSignOut(username string) (*cognitoidentityprovider.AdminUserGlobalSignOutOutput, error) {
	ret := _m.Called(username)
...
func (_m *SonarIdentityProvider) GetGroup(group string) (*cognitoidentityprovider.GetGroupOutput, error) {
	ret := _m.Called(group)
...
func (_m *SonarIdentityProvider) GetListUserInput(params map[string]string) *cognitoidentityprovider.ListUsersInput {
...
func (_m *SonarIdentityProvider) ListGroups(limit *int64, paginationToken *string) (*cognitoidentityprovider.ListGroupsOutput, error) {
...
func (_m *SonarIdentityProvider) ListUsers(listUserInput *cognitoidentityprovider.ListUsersInput) (*cognitoidentityprovider.ListUsersOutput, error) {
