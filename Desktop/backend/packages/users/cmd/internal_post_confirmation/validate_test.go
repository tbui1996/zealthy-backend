...
func (suite *ValidateSuite) TestValidate_OneGroup() {
...
func (suite *ValidateSuite) TestValidate_MoreThanOneGroupButForDifferentEnvironments() {
...
func (suite *ValidateSuite) TestValidate_NoSonarGroup() {
...
func (suite *ValidateSuite) TestValidate_MoreThanOneGroupForAnEnvironment() {
...
func (suite *ValidateSuite) TestValidate_IdpErr() {
	groupsMap := map[string][]string{"dev": {suite.groupName}}
